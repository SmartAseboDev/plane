...
urlpatterns = [
    ...
    path(
        "workspaces/<str:slug>/worklog-stats/",
        WorklogStatsEndpoint.as_view(),
        name="worklog-stats",
    ),
    path(
        "workspaces/<str:slug>/worklog-stats/export/",
        WorklogStatsExportEndpoint.as_view(),
        name="worklog-stats-export",
    ),
]
